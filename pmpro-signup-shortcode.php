...
function pmprosus_pmpro_email_data($data, $email) {
	...
	if ( ! empty( $_SESSION['pmprosus_autogenerated_password'] ) && strpos( $email->template, 'checkout_' ) !== false ) {
		$data['user_email'] = sprintf(
			...
			$_SESSION['pmprosus_autogenerated_password'],
			$data['user_email']
		);
				...
				<div class="pmpro_checkout-fields">
					...
					<?php if ( ! empty( $current_user->ID ) ) { ?>
						<p id="pmpro_account_loggedin">
							<?php printf(
								/* translators: 1: Current user login name, 2: WP Logout URL */
					...
					if( !empty( $tospage ) ){
						...
						?>
						<input type="checkbox" name="tos" value="1" id="tos" /> <label class="pmpro_label-inline pmpro_clickable" for="tos"><?php printf(
							/* translators: Terms of Service */
							__('I agree to the %s', 'paid-memberships-pro' ),
							$tospage->post_title
							);?></label>
						<?php
					} ?>
